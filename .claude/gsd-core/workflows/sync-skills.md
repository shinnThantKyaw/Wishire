...
INSTALL_JS_GLOBAL="/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
