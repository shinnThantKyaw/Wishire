...
ones). Reference: @/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/templates/spec.md.
