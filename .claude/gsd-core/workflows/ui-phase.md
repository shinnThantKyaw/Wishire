...
```markdown
Read /mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/agents/gsd-ui-checker.md for instructions.
