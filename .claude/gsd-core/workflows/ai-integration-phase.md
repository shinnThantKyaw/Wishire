...
<required_reading>
@/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/references/ai-frameworks.md
@/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/agents/gsd-eval-planner.md for instructions.
