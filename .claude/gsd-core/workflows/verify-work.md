...
<template>
@/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/workflows/diagnose-issues.md
