...
```
Agent(
  prompt="Read /mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/templates/VALIDATION.md`
