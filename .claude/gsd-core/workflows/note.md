...
- **Global scope**: `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/notes/`)
...
2. Glob `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/notes/` — works in any directory
