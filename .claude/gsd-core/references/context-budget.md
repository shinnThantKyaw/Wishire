...
The keys live in `.claude/settings.json` (project) or `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/settings.json` (global) — **not** in `.planning/config.json`:
