...
<!-- For checkpoint task examples and patterns, see @/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/references/checkpoints.md -->
...
See `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
