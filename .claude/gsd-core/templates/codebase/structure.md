...
- Usage: Reference from command with `@/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
