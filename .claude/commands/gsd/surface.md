...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/.gsd-surface.json`
(sibling to `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/skills/gsd-*/`.
...
(`/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude`), NOT the skills sub-directory (`/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude` as `configDir`. The skill dirs themselves live at
`/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Claude Code — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude}"
SCOPE="global"
...
(i.e. `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/.gsd-surface.json`
Install profile marker: `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/.gsd-profile`
Skill dirs: `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/skills/gsd-*/`
Engine module: `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/mnt/d/Programming/VibeCode-Tour/birthday-wish-generator/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
